...
jQuery(function ($) {
  ...
  if ('undefined' !== typeof QTags) {
    QTags.addButton('tablepress_quicktags_button',
    // ID
    tablepress_editor_button.caption,
    // button caption
    ...
    false,
    // access key
    tablepress_editor_button.title,
    // button title
...
/******/ })()
;
//# sourceMappingURL=quicktags-button.js.map