...
(function (global, factory) {
  ...
  // TablePress: Use `window` instead of `this` to get a global jspreadsheet object.
    ...
    if (jexcel.current) {
      if (jexcel.current.edition) {
        if (e.which == 27) {
          ...
          // Tab
          if (['calendar', 'html'].includes(jexcel.current.options.columns[jexcel.current.edition[2]].type)) {
            jexcel.current.closeEditor(jexcel.current.edition[0], true);
          } else {
            jexcel.current.edition[0].children[0].blur();
          }
      ...
      if (e.target.classList.contains('jexcel_selectall')) {
        ...
        if (jexcelTable[1] == 1) {
          ...
          if (columnId) {
            ...
            if (jexcel.current.options.columnResize == true && info.width - e.offsetX < 12) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region.
              // Resize helper
            ...
            } else if (jexcel.current.options.columnDrag == true && info.height - e.offsetY < 12) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region.
        ...
        if (jexcelTable[1] == 2) {
          ...
          if (e.target.classList.contains('jexcel_row')) {
            var info = e.target.getBoundingClientRect();
            if (jexcel.current.options.rowResize == true && info.height - e.offsetY < 12) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region.
              // Resize helper
              jexcel.current.resizing = {
            ...
            } else if (jexcel.current.options.rowDrag == true && info.width - e.offsetX < 18) {
              // TablePress: Changed from 6 to 18 pixels to increase draggable mouse region.
      ...
      if (jexcel.isMouseAction == true) {
        ...
        if (e.target.parentNode.parentNode && e.target.parentNode.parentNode.className) {
          if (e.target.parentNode.parentNode.classList.contains('resizable')) {
            if (e.target && x && !y && rect.width - (e.clientX - rect.left) < 12) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region.
              jexcel.current.cursor = e.target;
              jexcel.current.cursor.style.cursor = 'col-resize';
            } else if (e.target && !x && y && rect.height - (e.clientY - rect.top) < 12) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region.
              jexcel.current.cursor = e.target;
          ...
          if (e.target.parentNode.parentNode.classList.contains('draggable')) {
            if (e.target && !x && y && rect.width - (e.clientX - rect.left) < 18) {
              // TablePress: Changed from 6 to 18 pixels to increase draggable mouse region.
              jexcel.current.cursor = e.target;
              jexcel.current.cursor.style.cursor = 'move';
            } else if (e.target && x && !y && rect.height - (e.clientY - rect.top) < 12 && e.clientX - rect.left < rect.width - 24) {
              // TablePress: Changed from 6 to 12 pixels to increase draggable mouse region, and extended to not span full width.
              jexcel.current.cursor = e.target;
              jexcel.current.cursor.style.cursor = 'move';
            }
          }
...
/******/ })()
;
//# sourceMappingURL=jspreadsheet.js.map